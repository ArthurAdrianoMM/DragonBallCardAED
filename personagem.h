...
typedef struct{
    char nome[15];
    int vida=0, ki=0, ki_maximo, def=0, gold=0, n=0;
} personagem;
...
void definir_personagem(personagem *j){
    ...
    do{
        ...
        case 1: 
            ...
            printf("Habildade: tranformacoes duram ate o final do combate\n");
        ...
        case 3:
            ...
            printf("\"os Arcosianos, sao uma raca alienigena extremamente poderosa. Possuem forma humanoide com pele colorida, tendem a ser crueis\"\n");
